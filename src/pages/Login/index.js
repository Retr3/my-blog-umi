...
class AppLogin extends React.Component {
  state={
    ...
    url: new Date().getHours() > 6 && new Date().getHours() < 18 ?'https://api.mimiron.cn/public/images/login-morning.jpg':'https://api.mimiron.cn/public/images/login-night.jpg',  //背景图片
    loading:false,
  }
  componentDidMount(){
    this.initPage();
